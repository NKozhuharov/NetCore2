...
class BaseJoinData
{
    ...
    public function __construct(
        ...
        if (empty($tableToJoin)) {
            throw new Error("Provide the name of the table to join");
        }
    
        if (empty($tableField)) {
            throw new Error("Provide the names of the field from the joining table");
        }
    
        if (empty($parentField)) {
            throw new Error("Provide the names of the field from the parent table");
        }
    
        if (empty($parentTable)) {
            throw new Error("Provide the name of the parent table to join");
        }
